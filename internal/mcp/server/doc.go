...
// HTTP transport, per-subject rate limiting, structured request
// logging, Prometheus metrics, and CORS allowlist.
//
...
//
//   - HTTPHandler wraps mcp.NewStreamableHTTPHandler with the
//     middleware stack (auth, rate limit, metrics, recover). This is
//     what cmd/mcp/main.go binds to the public listener.
//
